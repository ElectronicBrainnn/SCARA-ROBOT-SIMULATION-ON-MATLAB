...
handles.Roll_val.String  = num2str(round(atan2(-T(2,3,4),T(3,3,4))*180/pi,2));
handles.Pitch_val.String = num2str(round(asin(abs(T(1,3,4)))*180/pi,2));
handles.Yaw_val.String   = num2str(round(atan2(T(1,2,4),T(1,1,4))*180/pi,2));
