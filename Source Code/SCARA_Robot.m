...
% Last Modified by GUIDE v2.5 15-Dec-2021 22:16:57
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.radiobutton_2Dcircular,'value',0);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.uip_Trajectory_tab1,'visible','on','position',[0.47 0.19 0.21 0.69]);
set(handles.uip_Trajectory_tab2,'visible','off','position',[0.47 0.19 0.48 0.69]);
set(handles.uip_Trajectory_tab3,'visible','off','position',[0.47 0.13 0.48 0.74]);
set(handles.btTrajectory_tab1,'BackgroundColor','green','fontweight','bold','fontsize',10);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.uip_Trajectory_tab1,'visible','off','position',[0.47 0.19 0.21 0.69]);
set(handles.uip_Trajectory_tab2,'visible','on','position',[0.47 0.19 0.48 0.69]);
set(handles.uip_Trajectory_tab3,'visible','off','position',[0.47 0.13 0.48 0.74]);
set(handles.btTrajectory_tab2,'BackgroundColor','green','fontweight','bold','fontsize',10);
...
set(handles.uip_Trajectory_tab1,'visible','off','position',[0.47 0.19 0.21 0.69]);
set(handles.uip_Trajectory_tab2,'visible','off','position',[0.47 0.19 0.48 0.69]);
set(handles.uip_Trajectory_tab3,'visible','on','position',[0.47 0.13 0.48 0.74]);
set(handles.btTrajectory_tab3,'BackgroundColor','green','fontweight','bold','fontsize',10);
set(handles.btTrajectory_tab1,'BackgroundColor',[0.94 0.94 0.94],'fontweight','normal','fontsize',8);
set(handles.btTrajectory_tab2,'BackgroundColor',[0.94 0.94 0.94],'fontweight','normal','fontsize',8);


% --- Executes on button press in radiobutton_2Dcircular.
function radiobutton_2Dcircular_Callback(hObject, eventdata, handles)
% hObject    handle to radiobutton_2Dcircular (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.radiobutton_circular,'value',0);
set(handles.radiobutton_linear,'value',0);
% Hint: get(hObject,'Value') returns toggle state of radiobutton_2Dcircular



function Pos_X_mid_Callback(hObject, eventdata, handles)
% hObject    handle to Pos_X_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Pos_X_mid as text
%        str2double(get(hObject,'String')) returns contents of Pos_X_mid as a double


% --- Executes during object creation, after setting all properties.
function Pos_X_mid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Pos_X_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Pos_Y_mid_Callback(hObject, eventdata, handles)
% hObject    handle to Pos_Y_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Pos_Y_mid as text
%        str2double(get(hObject,'String')) returns contents of Pos_Y_mid as a double


% --- Executes during object creation, after setting all properties.
function Pos_Y_mid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Pos_Y_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function Pos_Z_mid_Callback(hObject, eventdata, handles)
% hObject    handle to Pos_Z_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Pos_Z_mid as text
%        str2double(get(hObject,'String')) returns contents of Pos_Z_mid as a double


% --- Executes during object creation, after setting all properties.
function Pos_Z_mid_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Pos_Z_mid (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
